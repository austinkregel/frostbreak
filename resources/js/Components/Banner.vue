...
<template>
    <div>
        <div v-if="show && message"
            :class="[
                style == 'success'
                    ? 'bg-indigo-500 dark:bg-green-700'
                ...
                <div class="flex items-center justify-between flex-wrap">
                    <div class="w-0 flex-1 flex items-center min-w-0">
                        <span class="flex p-2 rounded-lg"
                            :class="[
                                style == 'success'
                                    ? 'bg-indigo-600 dark:bg-green-800'
                    ...
                    <div class="shrink-0 sm:ms-3">
                        <button
                            ...
                            :class="[
                                style == 'success'
                                    ? 'hover:bg-indigo-600 focus:bg-indigo-600 dark:hover:bg-green-800 dark:focus:bg-green-800'
                                    : 'hover:bg-red-600 focus:bg-red-600 dark:hover:bg-red-800 dark:focus:bg-red-800',
                            ]"
                            aria-label="Dismiss"
